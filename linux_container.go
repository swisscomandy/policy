...
type IPTablesManager interface {
	ContainerSetup(containerID, bridgeName string, ip net.IP, network *net.IPNet, externalIP net.IP, portRange string) error
...
func GetPortRange(space string) string {
...
func (c *LinuxContainer) Start() error {
	...
	err := c.ipTablesManager.ContainerSetup(
		c.ID(), c.Resources.Bridge, c.Resources.Network.IP, c.Resources.Network.Subnet, c.Resources.ExternalIP, portRange,
	)
	if err != nil {
